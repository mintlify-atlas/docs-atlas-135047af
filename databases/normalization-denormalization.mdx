...
<Note>
There are more normal forms such as 4NF, 5NF, and 6NF but we won't discuss them here. In a relational database, a relation is often described as _"normalized"_ if it meets the third normal form. Most 3NF relations are free of insertion, update, and deletion anomalies.
</Note>
...
<Warning>
Denormalization does not mean reversing normalization.
</Warning>
