...
description: Understanding databases, database management systems, and their core components
---
...
SQL and NoSQL databases are broad topics and are discussed separately in subsequent pages.
