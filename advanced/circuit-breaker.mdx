...
description: Learn about the circuit breaker pattern for building resilient systems
---
...
<Warning>
If we have many callers on an unresponsive supplier, we can run out of critical resources leading to cascading failures across multiple systems.
</Warning>
