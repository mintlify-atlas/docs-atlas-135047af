...
description: Learn about event-driven architecture and how it enables loose coupling through asynchronous event communication
---
...
<Note>
Dots in the diagram represents different events in the system.
</Note>
...
<Note>
Each of these methods is discussed separately in this course.
</Note>
