...
description: Learn about message brokers and how they enable applications, systems, and services to communicate
---
...
<Note>
We will discuss these messaging patterns in detail in the message queues and publish-subscribe sections.
</Note>
